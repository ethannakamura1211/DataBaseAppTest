...
public class employee_adapter extends ArrayAdapter<employee1> {
    ...
    public employee_adapter(Context mCtx, int listLayoutRes, List<employee1> employeeList, SQLiteDatabase mDatabase) {
    ...
    public View getView(int position, @Nullable View covertView, @NonNull ViewGroup parent) {
        ...
        final employee1 employee = employeeList.get(position);
    ...
    private void updateEmployee(final employee1 employee) {
